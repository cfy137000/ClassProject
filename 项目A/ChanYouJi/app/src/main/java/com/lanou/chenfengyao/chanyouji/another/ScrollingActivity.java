...
topIv.setAlpha(0f);
        ...
        appBarLayout.addOnOffsetChangedListener(new AppBarLayout.OnOffsetChangedListener() {
            ...
            public void onOffsetChanged(AppBarLayout appBarLayout, int verticalOffset) {
                ...
                Log.d("ScrollingActivity", "max:" + max);
                Log.d("ScrollingActivity", "-verticalOffset:" + -verticalOffset);
                Log.d("ScrollingActivity", "-verticalOffset/(float)max:" + ((-verticalOffset) / (float) max));
